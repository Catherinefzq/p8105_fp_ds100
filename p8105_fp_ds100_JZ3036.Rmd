...
data_IM_JZ %>% 
  mutate(., age_group_years = str_replace(age_group_years, '< 15', '< 25'),
            ...
            age_group_years = str_replace(age_group_years, '65–74', '64+'),
            age_group_years = str_replace(age_group_years, '75+', '64')) %>% 
  ...
  mutate(., age = forcats::fct_relevel(age_group_years, c('< 25', '25–44', '45–64', '64+'))) %>% 
