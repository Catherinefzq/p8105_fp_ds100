...
5. the model produced an adjusted $R^2$ = 0.6405, which represents there are 64% of the variability of the suicide rate are explained by the fitted model explanatory variables and it's a acceptable proportion to indicate a good fit for the data.
